...
| EVENT-LOOP-BLOCKING / async | B-009/010/017/018/022, C2-014/015, C4-017 | **pending** | formula eval timeout + inline row caps + batch/web-search/large-formula → background jobs (full async refactor, per user). Next phase. |
