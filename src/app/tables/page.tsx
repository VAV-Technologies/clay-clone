...
// /tables — Workbook & folder library. Holds the search bar, storage stats,
// New Folder / New Workbook buttons, and the project list. Lifted from the
// original homepage, which is now reserved for Agent X.
    ...
    <div className="flex items-center px-4 py-3 hover:bg-white/[0.03] transition-colors group">
      ...
      <div className="w-10 flex items-center justify-end self-stretch border-l border-white/10 pl-1">
        <button
          ...
          className="p-1.5 opacity-0 group-hover:opacity-100 hover:bg-white/10 transition-all"
        >
              ...
              <div className="w-16 h-1.5 bg-white/10 overflow-hidden ml-1">
                <div
                  className={cn(
                    ...
                    storageStats.storage.usagePercent > 80
                      ? 'bg-red-500'
                      : storageStats.storage.usagePercent > 50
                        ? 'bg-amber-500'
                        : 'bg-lavender'
                  )}
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex items-stretch px-4 py-3 border-b border-white/10 bg-white/[0.02]">
                <div className="flex-1 text-xs font-medium text-white/40 uppercase tracking-wider">
                  Name
                </div>
                <div className="w-32 hidden sm:flex items-center justify-center text-xs font-medium text-white/40 uppercase tracking-wider border-l border-white/10">
                  Modified
                </div>
